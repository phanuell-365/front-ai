...
<template>
  <div class="w-[98%] mr-auto">
    <div class="px-4 py-5 bg-blue-100 rounded-xl shadow-lg shadow-blue-400/10">
      ...
      <button type="button" v-if="props.isCopyable" @click="onCopyClick" @mouseleave="onCopyTextMouseLeave"
              ...
              class="btn btn-xs btn-ghost normal-case gap-1">
        <svg v-if="!isTextCopied" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
        ...
        <svg v-else-if="isTextCopied" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
